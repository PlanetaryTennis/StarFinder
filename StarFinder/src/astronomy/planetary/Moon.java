...
public class Moon extends Terrestrial implements OrbitObject {
	...
	public Moon(double myAtmosphere, double myRadius, double myMass,
			double myEccentricity, double myOrbit, Star star, double myAlbido, double myGreenHouse,
			double myWater, double myDay,double myMonth, double myMoonOrbit) {
		super(new Vector<Moon>(0), myAtmosphere, myRadius, myMass, myEccentricity, myOrbit, star, myAlbido, myGreenHouse, myWater, myDay);
	...
	public static Moon makeRandom(double orbit, double sitime, double planetmass, double radius, 
		...
		if(temps[2]>=(high)||temps[5]<=(low)||water < 0.1||water > 0.98||
	...
	public static Moon makeRandomJovian(double orbit, double sitime, double planetmass, double radius, double scale, Star star) {
