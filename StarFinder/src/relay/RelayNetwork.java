...
public class RelayNetwork implements Serializable{
	...
	private void Generate(double density) {
		...
		int sectors = myGalaxy.getMySectors().length;
		int regions = 0;
		int odd = 0;
		for(int i = 0;i < myGalaxy.getMySectors().length;i++) {
			regions += myGalaxy.getMySectors()[i].getRegions().length;
			if(ExtendedMathmatics.choose(myGalaxy.getMySectors()[i].getRegions().length,2) < myGalaxy.getMySectors()[i].getRegions().length*density) {
				odd += ExtendedMathmatics.choose(myGalaxy.getMySectors()[i].getRegions().length,2)-myGalaxy.getMySectors()[i].getRegions().length*density;
			}
		}
		...
		int zones = 0;
		for(int i = 0;i < myGalaxy.getMySectors().length;i++)
			for(int k = 0;k < myGalaxy.getMySectors()[i].getRegions().length;k++)
				zones += myGalaxy.getMySectors()[i].getRegions()[k].getMyZones().length;
		...
		for(int i = 0;i < myGalaxy.getMySectors().length;i++)
			for(int k = 0;k < myGalaxy.getMySectors()[i].getRegions().length;k++) {
				Pods[r] = new SecondaryRelay[myGalaxy.getMySectors()[i].getRegions()[k].getMyZones().length];
				for(int l = 0;l < myGalaxy.getMySectors()[i].getRegions()[k].getMyZones().length;l++) {
					...
					mySecondary[sc].setMySystem(myGalaxy.getMySectors()[i].getRegions()[k].getMyZones()[l].getMySystems()[ran.nextInt(myGalaxy.getMySectors()[i].getRegions()[k].getMyZones()[l].getMySystems().length)]);
					mySecondary[sc].setMyWorld(mySecondary[sc].getMySystem().getMyObjects()[ran.nextInt(mySecondary[sc].getMySystem().getMyObjects().length)]);
		...
		for(int i = 0;i < sectors;i++) {
			...
			b = i+1;
			if(b >= sectors)b = 0;
			z = ran.nextInt(myGalaxy.getMySectors()[i].getRegions()[0].getMyZones().length);
			s = ran.nextInt(myGalaxy.getMySectors()[i].getRegions()[0].getMyZones()[z].getMySystems().length);
			p = ran.nextInt(myGalaxy.getMySectors()[i].getRegions()[0].getMyZones()[z].getMySystems()[s].getMyObjects().length);
			...
			r = ran.nextInt(myGalaxy.getMySectors()[b].getRegions().length);
			z = ran.nextInt(myGalaxy.getMySectors()[b].getRegions()[r].getMyZones().length);
			s = ran.nextInt(myGalaxy.getMySectors()[b].getRegions()[r].getMyZones()[z].getMySystems().length);
			p = ran.nextInt(myGalaxy.getMySectors()[b].getRegions()[r].getMyZones()[z].getMySystems()[s].getMyObjects().length);
		...
		for(int i = 0;i < sectors;i++) {
			number = (int) ((myGalaxy.getMySectors()[i].getRegions().length*density-1)*2);
			tempnum = number/2;
			if(tempnum > ExtendedMathmatics.choose(myGalaxy.getMySectors()[i].getRegions().length, 2)) tempnum = ExtendedMathmatics.choose(myGalaxy.getMySectors()[i].getRegions().length, 2);
			number = tempnum * 2;
			map = mapOut(tempnum,myGalaxy.getMySectors()[i].getRegions().length);
			depth[i] = depthcluster(map, myGalaxy.getMySectors()[i].getRegions().length);
			for(int k = 0;k < map.length;k++) {
				...
				myPrimes[pc+1].setMyPartner(myPrimes[pc]);
				r = map[k][0];
				z = ran.nextInt(myGalaxy.getMySectors()[i].getRegions()[r].getMyZones().length);
				s = ran.nextInt(myGalaxy.getMySectors()[i].getRegions()[r].getMyZones()[z].getMySystems().length);
				p = ran.nextInt(myGalaxy.getMySectors()[i].getRegions()[r].getMyZones()[z].getMySystems()[s].getMyObjects().length);
