...
public class LaunchSettings implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if(1==JOptionPane.showConfirmDialog(LS,"Your Galaxy will have...\n"
				+ s + " Sectors \n"
				+ "Between " + rS + " And " + (rS+rE) + " Regions per Sector \n"
				+ "Between " + zS + " And " + (zS+zE) + " Zones per Region \n"
				+ "Between " + sS + " And " + (sS+sE) + " Systems per Zone \n"
				+ "At Most " + p + " Planets per System \n"
		...
		if(b) {
			MapView v = new MapView("Galaxy Painter",s,rS,rE,zS,zE,sS,sE,p,ss,ms,n,r);
		}else {
